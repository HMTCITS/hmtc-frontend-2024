    ...
    <main>
      <section className='relative h-screen overflow-clip bg-[#201F1F] text-white'>
        <div className='flex h-full w-full -translate-y-6 flex-col items-center justify-center gap-y-1'>
          <h1 className='bg-gradient-to-tr from-blue-600 to-blue-400 bg-clip-text font-libre-caslon-condensed text-[10rem] leading-tight text-transparent sm:text-[6rem] md:text-[9rem]'>
            Coming Soon
          </h1>
