...
const Akademik = () => {
  ...
  return (
    ...
    >
      <main className='z-10 flex w-full flex-col items-center justify-center space-y-4 py-10 text-center md:w-4/5 md:space-y-6 md:py-20'>
        <Typography variant='h1' className='text-2xl md:text-3xl lg:text-4xl'>
          ...
          <span className='font-satoshi text-2xl font-light md:text-3xl lg:text-4xl'>
            35 tahun menjadi wadah aspirasi, kreativitas,
          </span>
          <div className='font-satoshi text-2xl font-light md:text-3xl lg:text-4xl'>
        ...
        <Typography
          variant='h3'
          className='mt-6 font-libre text-sm md:text-xl lg:text-2xl'
          style={{
            marginBottom: 0,
            marginTop: 100,
            lineHeight: '1.2',
